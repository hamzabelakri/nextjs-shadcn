...
const languages = [
  { code: "en" as SupportedLanguage, label: "English", flag: "/flags/united-states.svg" },
  { code: "fr" as SupportedLanguage, label: "French", flag: "/flags/france.svg" },
  { code: "ar" as SupportedLanguage, label: "العربية", flag: "/flags/saudi-arabia.svg" },
];
