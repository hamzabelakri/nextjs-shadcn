...
const UserSignUpForm = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      setIsLoading(false);
      // Route to dashboard on successful signup
      ...
      <div className="grid gap-4">
        <div className="grid grid-cols-2 gap-4">
          <div className="grid gap-2">
            <label 
              htmlFor="firstName" 
              className={`text-sm font-medium leading-none transition-colors duration-200 ${formFocus === 'firstName' ? 'text-blue-500' : 'text-gray-700 dark:text-gray-300'}`}
            >
              First Name
            </label>
            <div className={`relative transition-all duration-300 ${formFocus === 'firstName' ? 'scale-[1.02]' : ''}`}>
              <input
                id="firstName"
                type="text" 
                ...
                onFocus={() => setFormFocus('firstName')}
                onBlur={() => setFormFocus(null)}
              />
              <div className={`absolute inset-0 rounded-md bg-blue-500/10 opacity-0 transition-opacity duration-300 pointer-events-none ${formFocus === 'firstName' ? 'opacity-100' : ''}`} />
            </div>
          </div>
          ...
          <div className="grid gap-2">
            <label 
              htmlFor="lastName" 
              className={`text-sm font-medium leading-none transition-colors duration-200 ${formFocus === 'lastName' ? 'text-blue-500' : 'text-gray-700 dark:text-gray-300'}`}
            >
              Last Name
            </label>
            <div className={`relative transition-all duration-300 ${formFocus === 'lastName' ? 'scale-[1.02]' : ''}`}>
              <input
                id="lastName"
                type="text" 
                className="flex h-11 w-full rounded-md border-0 bg-gray-50 dark:bg-gray-900 px-3 py-2 text-sm shadow-sm ring-1 ring-inset ring-gray-300 dark:ring-gray-700 focus:ring-2 focus:ring-inset focus:ring-blue-500 transition-all duration-200"
                ...
                onFocus={() => setFormFocus('lastName')}
                onBlur={() => setFormFocus(null)}
              />
              <div className={`absolute inset-0 rounded-md bg-blue-500/10 opacity-0 transition-opacity duration-300 pointer-events-none ${formFocus === 'lastName' ? 'opacity-100' : ''}`} />
            </div>
          </div>
        </div>
        ...
        <div className="grid gap-2">
          <label 
            ...
            className={`text-sm font-medium leading-none transition-colors duration-200 ${formFocus === 'confirmPassword' ? 'text-blue-500' : 'text-gray-700 dark:text-gray-300'}`}
          >
            Confirm Password
          </label>
          <div className={`relative transition-all duration-300 ${formFocus === 'confirmPassword' ? 'scale-[1.02]' : ''}`}>
            <input
              id="confirmPassword"
              type="password"
              className="flex h-11 w-full rounded-md border-0 bg-gray-50 dark:bg-gray-900 px-3 py-2 text-sm shadow-sm ring-1 ring-inset ring-gray-300 dark:ring-gray-700 focus:ring-2 focus:ring-inset focus:ring-blue-500 transition-all duration-200"
              ...
              onBlur={() => setFormFocus(null)}
            />
            <div className={`absolute inset-0 rounded-md bg-blue-500/10 opacity-0 transition-opacity duration-300 pointer-events-none ${formFocus === 'confirmPassword' ? 'opacity-100' : ''}`} />
          </div>
        </div>
...
export default function AsteroideaSignUp() {
        ...
        <div className="relative z-20 flex flex-col items-center justify-center flex-1 mt-4">
          <div className="max-w-md space-y-4">
            ...
            <p className="text-blue-100 text-base leading-relaxed">
              Create your account and start transforming urban mobility with intelligent technology and data-driven insights
            </p>
          </div>
        ...
        <div className="mx-auto flex w-full flex-col justify-center space-y-6 sm:w-[380px]">
          ...
          <div className="flex flex-col space-y-2 text-center">
            ...
            <p className="text-gray-500 dark:text-gray-400 text-sm">
              Join us and start managing your parking experience
            </p>
          </div>
