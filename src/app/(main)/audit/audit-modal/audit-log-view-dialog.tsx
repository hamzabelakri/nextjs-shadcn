        ...
        <div className='space-y-6'>
          <div className='grid grid-cols-2 gap-4'>
            <div>
              ...
              <p className='text-sm'>
                {format(new Date(currentRow.timestamp), 'PPpp')}
              </p>
            </div>
            <div>
              <h4 className='text-sm font-medium text-gray-500 mb-1'>User</h4>
              <p className='text-sm'>{currentRow.userName} ({currentRow.userEmail})</p>
            </div>
            <div>
            ...
            <div>
              ...
              <Badge variant='outline' className={getEntityColor(currentRow.entity)}>
                {currentRow.entity}
              </Badge>
            </div>
          </div>
          ...
          <div>
            ...
            <p className='text-sm font-mono'>{currentRow.ipAddress}</p>
          </div>

          <div>
            <h4 className='text-sm font-medium text-gray-500 mb-2'>User Agent</h4>
            <p className='text-sm text-gray-600 break-all'>{currentRow.userAgent}</p>
          </div>
